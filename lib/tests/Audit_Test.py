...
class Test_Audit(unittest.TestCase):
    ...
    def test_low_variance(self):
        self.assertEqual(low_variance_features(df_test).index.tolist(),['null_var'])
...
class Test_Get_Outliers(unittest.TestCase):
    ...
    def test_get_cat_outliers(self):
        ...
        self.assertEqual(out_cat_dict['job'], ['retired', 'entrepreneur', 'self-employed', 'housemaid', 'unemployed', 'student', 'unknown'])
